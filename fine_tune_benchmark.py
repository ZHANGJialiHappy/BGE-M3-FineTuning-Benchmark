...
dense_output_csv_path = "finetune_dense_incorrect_questions.csv"
sparse_output_csv_path = "finetune_sparse_incorrect_questions.csv"

# 加载 test_dataset.json
with open(test_dataset_path, mode="r", encoding="utf-8") as json_file:
    test_dataset = json.load(json_file)[:2] # delete [:2] to run the whole dataset
...
print(f"finetune_dense_score: {dense_score}/{total_questions}")
print(f"finetune_sparse_score: {sparse_score}/{total_questions}")
